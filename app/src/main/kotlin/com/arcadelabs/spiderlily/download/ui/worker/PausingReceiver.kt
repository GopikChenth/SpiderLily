...
import com.arcadelabs.spiderlily.core.util.ext.toUUIDOrNull
...
class PausingReceiver(
	...
	companion object {
		...
		private const val ACTION_PAUSE = "com.arcadelabs.spiderlily.download.PAUSE"
		private const val ACTION_RESUME = "com.arcadelabs.spiderlily.download.RESUME"
		private const val ACTION_SKIP = "com.arcadelabs.spiderlily.download.SKIP"
		private const val ACTION_SKIP_ALL = "com.arcadelabs.spiderlily.download.SKIP_ALL"
