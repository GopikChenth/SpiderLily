...
import com.arcadelabs.spiderlily.core.util.Throttler
import com.arcadelabs.spiderlily.core.util.ext.MimeType
import com.arcadelabs.spiderlily.core.util.ext.awaitFinishedWorkInfosByTag
import com.arcadelabs.spiderlily.core.util.ext.awaitUpdateWork
import com.arcadelabs.spiderlily.core.util.ext.awaitWorkInfosByTag
import com.arcadelabs.spiderlily.core.util.ext.deleteAwait
import com.arcadelabs.spiderlily.core.util.ext.deleteWork
import com.arcadelabs.spiderlily.core.util.ext.deleteWorks
...
import com.arcadelabs.spiderlily.core.util.ext.getWorkInputData
import com.arcadelabs.spiderlily.core.util.ext.getWorkSpec
...
import com.arcadelabs.spiderlily.core.util.ext.withTicker
import com.arcadelabs.spiderlily.core.util.ext.writeAllCancellable
import com.arcadelabs.spiderlily.core.util.progress.RealtimeEtaEstimator
import com.arcadelabs.spiderlily.download.domain.DownloadProgress
...
import com.arcadelabs.spiderlily.local.data.TempFileFilter
import com.arcadelabs.spiderlily.local.data.input.LocalMangaParser
import com.arcadelabs.spiderlily.local.data.output.LocalMangaOutput
import com.arcadelabs.spiderlily.local.domain.DeleteReadChaptersUseCase
import com.arcadelabs.spiderlily.local.domain.MangaLock
...
class DownloadWorker @AssistedInject constructor(
	...
	private val enforceStorageQuotaUseCase: com.arcadelabs.spiderlily.local.domain.EnforceStorageQuotaUseCase,
