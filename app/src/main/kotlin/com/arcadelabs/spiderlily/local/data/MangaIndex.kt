package com.arcadelabs.spiderlily.local.data
...
import com.arcadelabs.spiderlily_parser.util.json.getEnumValueOrNull
import com.arcadelabs.spiderlily_parser.util.json.getFloatOrDefault
import com.arcadelabs.spiderlily_parser.util.json.getIntOrDefault
import com.arcadelabs.spiderlily_parser.util.json.getLongOrDefault
import com.arcadelabs.spiderlily_parser.util.json.getStringOrNull
import com.arcadelabs.spiderlily_parser.util.json.mapJSONToSet
import com.arcadelabs.spiderlily_parser.util.json.toStringSet
...
class MangaIndex(source: String?) {
	...
	fun sortChaptersByName() {
		...
		val comparator = com.arcadelabs.spiderlily.core.util.AlphanumComparator()
