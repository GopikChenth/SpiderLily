...
import com.arcadelabs.spiderlily.core.exceptions.BadBackupFormatException
import com.arcadelabs.spiderlily.core.exceptions.CaughtException
...
import com.arcadelabs.spiderlily.core.exceptions.EmptyHistoryException
import com.arcadelabs.spiderlily.core.exceptions.EmptyMangaException
import com.arcadelabs.spiderlily.core.exceptions.IncompatiblePluginException
import com.arcadelabs.spiderlily.core.exceptions.InteractiveActionRequiredException
import com.arcadelabs.spiderlily.core.exceptions.NoDataReceivedException
...
import com.arcadelabs.spiderlily.core.exceptions.UnsupportedFileException
import com.arcadelabs.spiderlily.core.exceptions.UnsupportedSourceException
import com.arcadelabs.spiderlily.core.exceptions.WrapperIOException
...
import com.arcadelabs.spiderlily_parser.ErrorMessages.FILTER_BOTH_LOCALE_GENRES_NOT_SUPPORTED
import com.arcadelabs.spiderlily_parser.ErrorMessages.FILTER_BOTH_STATES_GENRES_NOT_SUPPORTED
import com.arcadelabs.spiderlily_parser.ErrorMessages.FILTER_MULTIPLE_GENRES_NOT_SUPPORTED
import com.arcadelabs.spiderlily_parser.ErrorMessages.FILTER_MULTIPLE_STATES_NOT_SUPPORTED
import com.arcadelabs.spiderlily_parser.ErrorMessages.SEARCH_NOT_SUPPORTED
...
fun FileNotFoundException.parseMessage(resources: Resources): String? {
    ...
    /storage/0000-0000/Android/media/d1f08350-0c25-460b-8f50-008e49de3873.jpg.tmp: open failed: EROFS (Read-only file system)
     /storage/emulated/0/Android/data/com.arcadelabs.spiderlily/cache/pages/fe06e192fa371e55918980f7a24c91ea.jpg: open failed: ENOENT (No such file or directory)
     /storage/0000-0000/Android/data/com.arcadelabs.spiderlily/files/manga/e57d3af4-216e-48b2-8432-1541d58eea1e.tmp (I/O error)
     */
    val groups = FNFE_MESSAGE_REGEX.matchEntire(message ?: return null)?.groupValues ?: return null
