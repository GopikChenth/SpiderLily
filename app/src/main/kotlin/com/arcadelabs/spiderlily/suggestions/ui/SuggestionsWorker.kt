...
import com.arcadelabs.spiderlily.core.model.getLocale
...
import com.arcadelabs.spiderlily.core.util.ext.awaitUniqueWorkInfoByName
...
import com.arcadelabs.spiderlily.core.util.ext.flatten
...
import com.arcadelabs.spiderlily.core.util.ext.sanitize
import com.arcadelabs.spiderlily.core.util.ext.takeMostFrequent
import com.arcadelabs.spiderlily.core.util.ext.toBitmapOrNull
import com.arcadelabs.spiderlily.core.util.ext.trySetForeground
...
import com.arcadelabs.spiderlily.suggestions.domain.MangaSuggestion
...
class SuggestionsWorker @AssistedInject constructor(
	...
	private companion object {
		...
		const val GROUP_SUGGESTION = "com.arcadelabs.spiderlily.SUGGESTIONS"
